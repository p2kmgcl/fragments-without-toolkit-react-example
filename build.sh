...
npx esbuild my-collection/my-fragment/index.jsx --log-level=error --bundle --format=esm --external:react --external:react-dom --outfile=build/my-collection/my-fragment/index.js
